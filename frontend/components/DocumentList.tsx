...
import { FileText, CheckCircle2, AlertCircle, HardDrive, Layers, ExternalLink } from 'lucide-react';
  ...
  const getDocTypeBadge = (type: string) => {
    switch (type) {
      ...
      default: {
        ...
        return <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-sky-50 text-sky-700 border border-sky-200">{label}</span>;
      }
    }
  };
